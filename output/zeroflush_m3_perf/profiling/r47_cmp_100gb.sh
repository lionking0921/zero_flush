#!/bin/bash
# R47：100GB / 1KB KV 读写对比（原生 RocksDB vs ZeroFlush 当前版）。
...
OUT=/home/embed/hyl/metadata_offload/output/zeroflush_m3_perf/profiling/R47
mkdir -p "$OUT"

COMMON="--benchmarks=fillrandom,readrandom --num=100000000 --reads=1000000 \
