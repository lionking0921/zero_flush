#!/usr/bin/env python3
"""R24：50GB 稳定性/完成度测试——最终配置 + 强化后台（针对 L0 消费）。
配置：align_l1 + 批次 freeze + cache 512MB + subcompactions=16 +
max_background_jobs=24（R20 基线 28.8K/247 停写；R24 预期消费端加速 → 吞吐提升、停写减少）。
"""
...
z.run_variant("R24", z.VARIANTS["R24"], z.HERE, force=True)
