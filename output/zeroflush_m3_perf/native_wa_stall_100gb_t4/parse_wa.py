...
EXP = os.path.join(BASE, "output/zeroflush_m3_perf/native_wa_stall_100gb_t4")
LOG = __import__("sys").argv[1] if len(__import__("sys").argv) > 1 else "/tmp/wa_exp_t4/LOG"
OUT = os.path.join(EXP, "native_wa_stall_100gb_t4.json")
...
def main():
    ...
    result = {
        "experiment": "native rocksdb 100GB/1KB fillrandom (4 threads)",
